...
export default function OurTeam() {
    return (
        <div className="min-h-screen w-full flex items-center justify-center font-ru py-16 md:py-0" style={{ background: 'radial-gradient(ellipse at bottom right, #FA9819 0%, #FA9819 70%, #FA9819 100%)' }}>
